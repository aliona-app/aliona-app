...
export const appDesignDescriptions = {
  gray: 'Нейтральный и спокойный. Хорошо дружит с тёмной и ночной темой чтения.',
  graphite: 'Холодный премиальный тёмный интерфейс под вечернее чтение.',
  paper: 'Светлый тёплый интерфейс, особенно хорошо сочетается со светлой темой и сепией.',
  plum: 'Мягкий акцентный дизайн без перегруза, подходит для тёмной и ночной темы.',
  emerald: 'Спокойный зелёный дизайн с мягким контрастом и хорошей читаемостью.',
  aurora: 'Более яркий холодный стиль с акцентами, если хочется живее.'
};
